        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <?php
                    ...
                    $user_subscriber_counts = mysqli_num_rows($select_all_subscriber_users);
                ?>
                    ...
                    <script type="text/javascript">
                        ...
                        function drawChart() {
                            ...
                            <?php 
                                ...
                                $element_count = [$post_counts, $post_published_counts, $post_draft_counts, $comment_counts, $comment_unapproved_counts, $user_counts, $user_subscriber_counts, $cat_counts];
                                for($i = 0; $i < 7; $i++){
